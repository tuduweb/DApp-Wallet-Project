App = {
  ...
  setupWallet: function (wallet) {
    ...
    App.provider = new ethers.providers.JsonRpcProvider("http://172.20.144.113:8545");
...
// 模拟一次点击获取数据
  ...
  initToken: function() {
    ...
    $.getJSON('TutorialToken.json', function(data) {
      ...
      const address = '0xBCB1dfc48CE120854aDC242cFEDc4D8c12d3FdCB'//data.networks["1616594738951"].address;//1337
      console.log(address);
